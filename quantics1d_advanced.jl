...
# ╔═╡ 84193dab-f772-447b-8c8a-bc46d5a2d71d
begin
...
notebook = "quantics1d_advanced.jl"
...
# ╔═╡ 066d2ac8-a9a1-4d98-a31e-bab5566d1958
md"""
...
# ╔═╡ c9d45bbc-c23f-427e-8bf8-5ea51d539d23
md"""
```julia
...
# ╔═╡ 9a065cdc-5cfd-4b24-a529-20422628b47b
md"""
...
# ╔═╡ 0c9eac91-99c7-4613-ba04-99a8bb512ae6
md"""
...
# ╔═╡ 36063722-609e-4acd-8340-5d86a4397ec2
begin
    R = 40 # number of bits
    xmin = 0.0
    xmax = log(20)
...
# ╔═╡ 44353d0b-ee68-4d17-bc95-5ae002c6c0da
md"""
We now define a function that takes a quantics index, which is named `qf`.
"""

# ╔═╡ c9490dba-9814-4354-8d18-630dcb2d006e
begin
...
# ╔═╡ 18b5d059-98ee-42d8-b6e4-6348a857ca8e
md"""
...
# ╔═╡ 87cbea37-c332-497c-a73c-31f73f510a88
ci, ranks, errors = TCI.crossinterpolate2(
    Float64, cf, localdims, initialpivots; maxbonddim = 15)

# ╔═╡ 9cf65a3f-3822-4592-ad76-c0d16f167593
md"""
...
# ╔═╡ 0fa89b30-4171-4ec7-80a3-09ac26084063
md"""
...
# ╔═╡ 2fc85737-cb8b-45d9-92a3-5d3316ecf7a8
begin
    x = 0.2
...
# ╔═╡ bb62d10a-0d23-464f-891e-cd5e22db900f
...
manifest_format = "2.0"
project_hash = "3ad0c9eb314fb958f27d0c2e84d4fc2871af0373"
