...
Thus, if the input function $f$ is given in the quantics representation as $(resource_qft1), 

then $\hat{f} = T f$ can be computed by efficiently contracting the tensor trains for $T$ and $f$ and recompressing the result: 
...
If you are familiar with quantum field theories, you can think of $f(x)$ as a bosonic correlation function."""
...
# ╔═╡ a463bbb3-5a6c-4b09-a3d9-5cdb467c77c4
begin
...
manifest_format = "2.0"
project_hash = "efd50fc39f3cd7e4e8da14b708b9c29246194acd"
...
[[deps.FastMPOContractions]]
deps = ["ITensorTDVP", "ITensors", "LinearAlgebra", "StaticArrays"]
git-tree-sha1 = "4b141e1933c0d3b6d4a197886db662d293db5013"
uuid = "f6e391d2-8ffa-4d7a-98cd-7e70024481ca"
version = "0.2.5"
...
[[deps.ITensorTDVP]]
deps = ["Adapt", "Compat", "ITensors", "KrylovKit", "LinearAlgebra", "NDTensors", "PackageExtensionCompat", "Printf", "TimerOutputs"]
git-tree-sha1 = "830e0d07d5dbcbd02abc514fda06a702e565df09"
uuid = "25707e16-a4db-4a07-99d9-4d67b7af0342"
version = "0.4.10"

    [deps.ITensorTDVP.extensions]
    ITensorTDVPObserversExt = "Observers"

    [deps.ITensorTDVP.weakdeps]
    Observers = "338f10d5-c7f1-4033-a7d1-f9dec39bcaa0"

[[deps.ITensors]]
deps = ["Adapt", "BitIntegers", "ChainRulesCore", "Compat", "Dictionaries", "DocStringExtensions", "Functors", "IsApprox", "KrylovKit", "LinearAlgebra", "LinearMaps", "NDTensors", "PackageExtensionCompat", "Pkg", "Printf", "Random", "Requires", "SerializedElementArrays", "SimpleTraits", "StaticArrays", "Strided", "TimerOutputs", "TupleTools", "Zeros"]
git-tree-sha1 = "62ae01051c7e503efb384606850c440d23cba3f5"
...
[[deps.Quantics]]
deps = ["EllipsisNotation", "FastMPOContractions", "ITensors", "LinearAlgebra", "SparseIR", "StaticArrays"]
...
git-tree-sha1 = "08f4b590c5181a206146a4c122ff58a1e30e5e1e"
...
[[deps.TCIITensorConversion]]
deps = ["ITensors", "TensorCrossInterpolation"]
git-tree-sha1 = "4ff840bac4300e78a9126965aa00f817e05b105b"
